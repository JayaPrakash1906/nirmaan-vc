...
const contacts = [
    { name: 'prasath', designation: 'tech_support', organisation: 'OIE', connectFor: 'tech' },
    { name: 'Aakarsh Naidu', designation: 'CEO', organisation: 'Startupreneur', connectFor: 'Mentoring' }
  ];
