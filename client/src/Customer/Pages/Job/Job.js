...
function Jobs()
{
    return(
        ...
        <div className="items-center px-4 py-4 mt-2 sm:mt-10 md:mt-1 p-8">
          ...
          <button type="button" onClick={() => window.location.href= "http://localhost:3000/jobs/new"} className="active:scale-[.90] active:duration-70 hover:scale-[1.02] border border-green-300 rounded-md bg-green-500 transition-all ease-in-out md:text-xs font-semibold p-2 text-white"><span>Post A New Job</span></button>
         </div>
         <div className=" flex flex-col items-left justify-center p-2 m-16 border ">
          ...
          <form className='p-4 w-[500px] relative'>
            ...
            <input type="text" className="border border-blue-300 rounded-md bg-white-500 ms-4 md:h-[34px;] sm:w-[50%]" placeholder="Search Jobs"></input>
            </div>
                </form>
